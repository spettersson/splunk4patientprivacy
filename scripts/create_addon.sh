...
read -p "Enter the name of the vendor and technology that this add-on is dedicated for (only alfanumeric and whitespace characters; for example, Cambio COSMIC): " VENDOR_AND_PRODUCT

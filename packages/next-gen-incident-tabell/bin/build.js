...
const runCommands = {
    win32: {
        ...
        link: () => shell.exec('mklink /D "%SPLUNK_HOME%\\etc\\apps\\next-gen-incident-tabell" "%cd%\\demo\\splunk-app"'),
    },
    nix: {
        ...
        link: () => shell.exec('ln -s $PWD/demo/splunk-app $SPLUNK_HOME/etc/apps/next-gen-incident-tabell-demo-app'),
    },
};

...
To establish deep insights into employee behaviour and proactively detect policy violations, it is important to understand the key pieces of data needed. Although different use cases may require different data, generally speaking, they rely on three **data categories**:

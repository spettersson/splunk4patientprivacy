...
description: This detection looks for specific signals that may indicate the existence of a legitimate care relationship between 
          staff members and patients. It can provide valuable input to the logic used to group observations to surface alerts, and also 
...
- tags:
          ...
          prescription (=identifies EHR audit events where a users prescribes or orders medication for a patient, regardless of source system) 
          diagnosis (=identifies EHR audit events where users adds/updates/removes a diagnosis for a patient, regardless of source system) 
